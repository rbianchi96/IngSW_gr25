...
public class MoveWindowPatternDiceSelectedColorEffect extends Effect {
    ...
    public MoveWindowPatternDiceSelectedColorEffect(ArrayList<PlacementRestriction> ignoredRestriction) {
        this.ignoredRestriction = ignoredRestriction;
        this.effectType = EffectType.MOVE_WINDOW_PATTERN_DICE_SELECTED_COLOR;
    }
    @Override
